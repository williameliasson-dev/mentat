...
Note apps are all bloated.
Do I wanna run electron ram and CPU hogger to wrote simple notes that can be written in something as simple as
in vim or nano. fak no.

Do I wanna setup & mount a SFTP server that i have to connect to via a VPN tunnel that will be wonky if i disconnect. fak no.
...
I don't want LLM built in features most technically inclined people already handle this on their own.
